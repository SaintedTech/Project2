...
public class MenuActivity  extends AppCompatActivity implements AbstractView, View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.getPuzzles.setOnClickListener(this);
    ...
    public void onClick(View view) {
        ...
        else if (view.getId() == R.id.getPuzzles){
